...
<p>The system also allows the residents of the County to get feedback from the County Government on the status of various service delivery issues that have been reported by the residents of the county.</p>
        ...
        <div>
            <h3 id="header2">
                Reports in this setor - <?php echo $sectorname; ?>
            </h3>
              <table class="table table-striped">
                                ...
                                //get the reported events in this sector in a table
                                       ...
                                       //the url to call the json data
                                        $scounty_link=file_get_contents("http://www.prisconet.com/apps/county/getreport.php?sectorid=$sectorid2");
                                        error_reporting(E_ERROR | E_PARSE);        
         ...
         <div>
            <h3 id="header2">
             ...
             <?php
               //the url to call
              $thesummary=file_get_contents("http://www.prisconet.com/apps/county/getsummary.php?sectorid=$sectorid2");
              echo $thesummary;
              ?>
             <br/>
             <b>Pending Events: </b>
             <?php
               //the url to call
              $thesummary=file_get_contents("http://www.prisconet.com/apps/county/getsummary.php?status=Pending&sectorid=$sectorid2");
              echo $thesummary;
              ?>
             <br/>
             <b>Solved Events: </b>
             <?php
               //the url to call
              $thesummary=file_get_contents("http://www.prisconet.com/apps/county/getsummary.php?status=Resolved&sectorid=$sectorid2");
              echo $thesummary;
              ?>
             <br/>
             <b>Fowarded Events: </b>
             <?php
               //the url to call
              $thesummary=file_get_contents("http://www.prisconet.com/apps/county/getsummary.php?status=Fowarded&sectorid=$sectorid2");
              echo $thesummary;
              ?>
             <br/>
             ...
             <?php
               //the url to call
              $thesummary=file_get_contents("http://www.prisconet.com/apps/county/getsummary.php?status=Dismissed&sectorid=$sectorid2");
              echo $thesummary;
              ?>
             <br/>
         </div> 
