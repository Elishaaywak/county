                                ...
                                $sectorid=$_GET['secid'];
                                       //the url to call the json data
                                        ...
                                        foreach ($data as $sc) {
                                                                ...
                                                                ?>
                                    <tr><td><?php echo $name;?></td><td><?php echo $report;?></td><td><?php echo $location;?></td><td><?php echo $date;?></td><td><?php echo $time;?></td><td><?php echo $status;?></td>
                                        </tr>
                                                              <?php
                                                                }
