...
//get the sub-county, startdate and end date
$sub_countyid=$_GET['sub_countyid'];
        ...
        <div>
         ...
         <div>
            <h3 id="header2">
             ...
             <?php
               //the url to call
              $thesummary=file_get_contents("http://www.prisconet.com/apps/county/getfpdf.php?sub_countyid=$sub_countyid&startdate=$startdate&enddate=$enddate");
              echo $thesummary;
              ?>
             <br/>
             <b>Pending Events: </b>
             <?php
               //the url to call
              $thesummary=file_get_contents("http://www.prisconet.com/apps/county/getfpdf.php?sub_countyid=$sub_countyid&startdate=$startdate&enddate=$enddate&status=Pending");
              echo $thesummary;
              ?>
             <br/>
             <b>Solved Events: </b>
             <?php
               //the url to call
              $thesummary=file_get_contents("http://www.prisconet.com/apps/county/getfpdf.php?sub_countyid=$sub_countyid&startdate=$startdate&enddate=$enddate&status=Resolved");
              echo $thesummary;
              ?>
             <br/>
             <b>Fowarded Events: </b>
             <?php
               //the url to call
              $thesummary=file_get_contents("http://www.prisconet.com/apps/county/getfpdf.php?sub_countyid=$sub_countyid&startdate=$startdate&enddate=$enddate&status=Fowarded");
              echo $thesummary;
              ?>
             <br/>
             ...
             <?php
               //the url to call
              $thesummary=file_get_contents("http://www.prisconet.com/apps/county/getfpdf.php?sub_countyid=$sub_countyid&startdate=$startdate&enddate=$enddate&status=Dismissed");
              echo $thesummary;
              ?>
             <br/>
         </div> 
