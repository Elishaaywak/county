...
<div class="wrapper">
        ...
        <nav class="navbar navbar-inverse navbar-fixed">
            <div class="container-fluid">
                <div class="navbar-header">
                    ...
                    <a class="navbar-brand" href="#">Sub-Counties & Wards
                    <?php
    ...
    if (isset($_SESSION['success']))
    {
        ?>
            ...
            <meta content="2;awards.php" http-equiv="refresh" />
    <?php
    //unset the session
                ...
                <div class="row">
                    <div class="col-md-8">
                        <div class="card">
                            ...
                            {
                                echo "<h4>Please Select a sub-county from the right pane to view details</h4>";
                            }
                            else 
                            {
                                ...
                                //the url to call the json data
                                        $scounty_link=file_get_contents("http://www.prisconet.com/apps/county/getsubcounty.php?scountyid=$_GET[scountyid]");
                                        error_reporting(E_ERROR | E_PARSE);        
                                        $data = json_decode($scounty_link,true);
                            ...
                            ?>
                            <div class="header">
                                <h4 class="title">View Sub-County : <?php echo $scname; ?> <small><a href="deletescounty.php?scountyid=<?php echo $scountyid;?>" onclick="return confirm('Are you sure?')">Delete</a></small></h4>
                            </div>
                            <div class="content">
                              <form action="updatesubcounty.php" method="post">
                                    <div class="form-group">
                                    <label for="scounty">Update/ Edit Sub-county Name:</label>
                                    <input type="text" class="form-control" id="scounty" name="scounty" required>
                                    <input type="hidden" name="id" value="<?php echo $_GET['scountyid']; ?>"/>
                                    </div>
                                    <button type="submit" class="btn btn-default">Update</button>
                                </form> 
                                <hr/>
                                <h3><u>Wards in the Sub-County</u></h3>
                                
                                <?php
                                //get the details of the sub-county
                                //the url to call the json data
                                        $ward_link=file_get_contents("http://www.prisconet.com/apps/county/getward.php?scountyid=$_GET[scountyid]");
                                        error_reporting(E_ERROR | E_PARSE);        
                                        ...
                                        foreach ($data as $wd) 
                                            {
                                                                $wardname = $wd["name"];
                                                                $wardid = $wd["wardid"];
                                                                echo "<big>- $wardname </big>"?>
                                <small><a href="#ward<?php echo $wardid; ?>" data-toggle="collapse">Edit</a>

                                                    <div id="ward<?php echo $wardid; ?>" class="collapse">
                                                        <form class="form" method="post" action="updateward.php">
                                                            <input class="form" type="text" name="name" placeholder="Input ward name and press Enter"/>
                                                            <input type="hidden" name="scountyid" value="<?php echo $_GET['scountyid']; ?>"/>
                                                            <input type="hidden" name="wardid" value="<?php echo $wardid; ?>"/>
                                                        </form>
                                                    </div> | <a href="deleteward.php?wardid=<?php echo $wardid?>" onclick="return confirm('Are you sure?')">Delete</a></small><br/>
                                                                <?php
                               ...
                               <?php
                                       //the url to call the json data
                                        ...
                                        foreach ($data as $sc) {
                                                                ...
                                                                //into the url
                                                                ?>
                              <a href="awards.php?scountyid=<?php echo $scountyid; ?>"><?php echo $name;?></a><br/>
                                                                <?php
                                                                }
