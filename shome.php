        ...
        <div class="content">
            <div class="container-fluid">
                <div class="row">
                    <div class="col-md-12">
                        <div class="card">
                            <h3><?php echo " Fowarded Reports- <small>$sectorname Sector</small></a>"; ?></h3>
                            <table class="table table-striped">
                                ...
                                //get the reported events in this sector and displaythem in a table
                                       ...
                                       //the url to call the json data
                                        $scounty_link=file_get_contents("http://www.prisconet.com/apps/county/getreport.php?sectorid=$thesector&status=Fowarded");
                                        error_reporting(E_ERROR | E_PARSE);        
                                        $data = json_decode($scounty_link,true);
