                ...
                <nav class="navbar navbar-inverse navbar-fixed">
                    <div class="container-fluid">
                        <div class="navbar-header">
                            ...
                            <a class="navbar-brand" href="#">Sector Users
                                <?php
...
if (!isset($_GET['sectorid'])) {
    echo "<h4>Please Select a sector from the right pane to view the sector users in that sector</h4>";
} else {

    //get the details of the sector
    //the url to call the json data
    $sector_link = file_get_contents("http://www.prisconet.com/apps/county/getsector.php?sectorid=$_GET[sectorid]");
    error_reporting(E_ERROR | E_PARSE);
    ...
    ?>
                                        <div class="header">
                                            <h4 class="title">View Sector Users : <?php echo "$sectorname"; ?></h4>
                                        </div>
                                        <div class="content">
                                        ...
                                        //the url to call the json data
                                        $admin_link = file_get_contents("http://www.prisconet.com/apps/county/getsuser.php?sectorid=$_GET[sectorid]");
                                        error_reporting(E_ERROR | E_PARSE);
                                        ...
                                        foreach ($data as $ad) {
                                            ...
                                            ?><small><a href="deletesuser.php?userid=<?php echo $userid; ?>" onclick="return confirm('Are you sure?')">Delete</a></small><br/>
                                                <?php
                                            }
                                            ?>
                                        </div>
                            ...
                            <div class="col-md-4">
                                <div class="card card-user">
                                    ...
                                    //the url to call the json data
                                    $sector_link = file_get_contents("http://www.prisconet.com/apps/county/getsector.php");
                                    error_reporting(E_ERROR | E_PARSE);
                                    ...
                                    foreach ($data as $sec) {
                                        $sectorname = $sec["name"];
                                        $sectorid = $sec["serviceid"];
                                        ?><small><a href="asectoruser.php?sectorid=<?php echo $sectorid; ?>"><?php echo "<big>- $sectorname </big>" ?></a></small><br/>
                                                <?php
                                            }
                                            ?>   
