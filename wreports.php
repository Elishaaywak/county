...
//the url to call the json data
                                        $ward_link=file_get_contents("http://www.prisconet.com/apps/county/getwadmin.php?adminid=$_SESSION[wuserid]");
		...
		var chart = new CanvasJS.Chart("chartContainer",
		{
			...
			{        
				...
				dataPoints: [
                                    <?php
                                       //the url to call the json data
                                        $daily_link=file_get_contents("http://www.prisconet.com/apps/county/getdaily.php?wardid=$wardid");
                                        error_reporting(E_ERROR | E_PARSE);        
			...
			{        
				...
				<?php
                                       //the url to call the json data
                                        $foward_link=file_get_contents("http://www.prisconet.com/apps/county/getfowarded.php?wardid=$wardid");
                                        error_reporting(E_ERROR | E_PARSE);        
				...
				<?php
                                       //the url to call the json data
                                        $dismissed_link=file_get_contents("http://www.prisconet.com/apps/county/getdismissed.php?wardid=$wardid");
                                        error_reporting(E_ERROR | E_PARSE);        
        ...
        <nav class="navbar navbar-inverse navbar-fixed">
            <div class="container-fluid">
                <div class="navbar-header">
                    ...
                    <a class="navbar-brand" href="#">All Reported Events
                    <?php
                                       //the url to call the json data
        ...
        <div class="content">
            <div class="container-fluid">
                <div class="row">
                    <div class="col-md-12">
                        <div class="card">
                            <h3>All reported events in My ward <small><a href="wpdf.php" target="_blank">Download PDF</a></small></h3>
                                ...
                                //get the reported events in this ward and displaythem in a table
                                       ...
                                       //the url to call the json data
                                        ...
                                        foreach ($data as $sc) {
                                                                ...
                                                                ?>
                                    <tr><td><?php echo $name;?></td><td><?php echo $email;?></td><td><?php echo $telephone;?></td><td><?php echo $report;?></td><td><?php echo $nearest;?></td><td><?php echo $date;?></td><td><?php echo $time;?></td><td><?php echo $status;?></td>
                                        <td><a href="wdetails.php?reportid=<?php echo $reportid;?>">Details</a></td></tr>
                                                              <?php
                                                                }
