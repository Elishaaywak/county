...
$value = "http://www.prisconet.com/apps/county/filterpdf.php?sub_countyid=$_GET[sub_countyid]&startdate=$_GET[startdate]&enddate=$_GET[enddate]"; // can aso be a url, starting with http..
