...
} else if (isset($_SESSION['monitoringid'])) {
                    ...
                    <div class="row">
                        <div class="col-md-7 col-sm-offset-1">
                            <div class=" well well-lg">
                                <blockquote>Welcome To Service Delivery Monitoring System in Nairobi County</blockquote>
                                <p><b>This is a Mobile, Web and SMS based Systems that allows residents of Nairobi County in Kenya to report to the county government services that are not being delivered as required.</b></br></br>
                                <b>The system also allows the residents of the County to get feedback from the County Government on the status of various service delivery issues that have been reported by the residents of the county.
                                The Mobile app is available in Android, iOS and Windows mobile version. 
                                The Android version can be accessed by clicking the link below.<br/><br/>
                                To use the SMS Service, send a message using the *ward_id*sector_id*name*report*nearest location# to the number +254703395018
 and you will receive a confirmation message telling you that the report was successful.<br/><br/>
                                To get the format in which the SMS is supposed to be sent, send the word "Format" to +254703395018.<br/><br/> 
                                To get the ID of the sector send the word Sector to the number +254703395018<br/><br/>
                                To get the ID of the ward send the word Ward to the number +254703395018
                                </p></br></br>
                                    <br/><br/>
                                    <a type="button" class="btn btn-success" href="help.php">Learn More...</a> &nbsp;&nbsp;
                                    <button type="button" class="btn btn-success" data-toggle="modal" data-target="#report">Report a new event</button> &nbsp;&nbsp;
                                    <a type="button" class="btn btn-success" href="api.php">Developer API</a> &nbsp;&nbsp;
                                    <a type="button" class="btn btn-success" href="app-release.apk" target="_blank">Download App</a>
                            </div>
                        </div>
                        <div class="col-md-4">
                            <div class="card card-user">
                                ...
                                <div class="content"><big>
                                        ...
                                        <blockquote>Ward Admin /Sector User /Monitoring & Evaluation Login </blockquote><hr/>
