                ...
                <div class="row">
                    ...
                    <div class="col-md-9">
                       ...
                       //get the details of the sub-county
                                       ...
                                       //the url to call the json data
                                        $scounty_link=file_get_contents("http://www.prisconet.com/apps/county/getsector.php?sectorid=$_GET[secid]");
                                        error_reporting(E_ERROR | E_PARSE);        
                                        $data = json_decode($scounty_link,true);
                       ...
                       //display the name of the sub-county
                               ...
                               //if the wardid is not set, display a message
                                                                if (!isset($_GET['secid']))
                                                                {
                                                                    echo"<blockquote>Please select a sector from the right pane to view the reports in the ward</blockquote>";
                                                                }
                                                                else
                                                                {
                                                                    ?>
...
function initMap() {
    ...
    var markers = [
        ...
        //the url to call the json data
        $sectorid=$_GET['secid'];
                                        $map_link=file_get_contents("http://www.prisconet.com/apps/county/getreport.php?sectorid=$sectorid");
                                        error_reporting(E_ERROR | E_PARSE);        
...
<div id="mapCanvas"></div>                            
                    ...
                    <div class="col-md-3"><h4>Other Sectors</h4>
                     <?php
                                       //the url to call the json data
                                        $scounty_link=file_get_contents("http://www.prisconet.com/apps/county/getservice.php");
                                        error_reporting(E_ERROR | E_PARSE);        
                                        ...
                                        foreach ($data as $sc) {
                                                                ...
                                                                $serviceid = $sc["serviceid"];
                                                                //into a drop down menu
                                                                ?><a href="secreport.php?secid=<?php echo $serviceid;?>"><?php echo $name;?></a><br/><hr/><?php
                                                                }
