...
<div class="wrapper">
            ...
            <div class="container-fluid">
                <div class="navbar-header">
                    ...
                    <?php
                                       //the url to call the json data
                                        ...
                                        $thesector_link=file_get_contents("http://www.prisconet.com/apps/county/getsector.php?sectorid=$sectorid");
                                        error_reporting(E_ERROR | E_PARSE);        
                ...
                <div class="collapse navbar-collapse">
                    ...
                    <ul class="nav navbar-nav navbar-right">
                        <li>
                           <a href="">
                               Account echo <?php echo $sectorid; ?>
                            </a>
                        </li>
                        <li class="dropdown">
    ...
    if (isset($_SESSION['success']))
    {
        ...
        <meta content="2;suser.php" http-equiv="refresh" />
    <?php
    //unset the session
                    ...
                    <div class="col-md-8">
                        <div class="card">
                            <div class="header">
                                ...
                                <h3><?php echo "<small>$sectorname Sector</small></a>"; ?></h3>
                            </div>
                            <div class="content">
                                <form action="updatesuser.php" method="post" enctype="multipart/form-data">
                            ...
                            <div class="content">
                                <div class="author">
                                     <a href="#">
                                         <?php
                                       //the url to call the json data
                                        $user_link=file_get_contents("http://www.prisconet.com/apps/county/getsuser.php?suserid=$_SESSION[suserid]");
                                        error_reporting(E_ERROR | E_PARSE);        
