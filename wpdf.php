...
//the url to call the json data
                                       ...
                                       //get the name of the ward
                                        $sector_link=file_get_contents("http://www.prisconet.com/apps/county/getward.php?wardid=$wardid");
                                        error_reporting(E_ERROR | E_PARSE);        
...
<script>
    ...
    <body>
       <a href="convert_ward.php?page=pdf2&wardid=<?php echo $theward; ?>" class="btn btn-default">Download PDF</a>&nbsp;&nbsp;&nbsp;<a href="index.php" class="btn btn-default">Homepage</a>
        <div id="mainbody">
...
<p>The system also allows the residents of the County to get feedback from the County Government on the status of various service delivery issues that have been reported by the residents of the county.</p>
        ...
        <div>
            <h3 id="header2">
                Reports in this ward - <?php echo $wardname; ?>
            </h3>
              <table class="table table-striped">
                                ...
                                //get the reported events in this sector in a table
                                       ...
                                       //the url to call the json data
                                        $scounty_link=file_get_contents("http://www.prisconet.com/apps/county/getreport.php?wardid=$theward");
                                        error_reporting(E_ERROR | E_PARSE);        
                                        $data = json_decode($scounty_link,true);
         ...
         <div>
            <h3 id="header2">
             ...
             <?php
               //the url to call
              $thesummary=file_get_contents("http://www.prisconet.com/apps/county/getsummary.php?wardid=$theward");
              echo $thesummary;
              ?>
             <br/>
             <b>Pending Events: </b>
             <?php
               //the url to call
              $thesummary=file_get_contents("http://www.prisconet.com/apps/county/getsummary.php?status=Pending&wardid=$theward");
              echo $thesummary;
              ?>
             <br/>
             <b>Solved Events: </b>
             <?php
               //the url to call
              $thesummary=file_get_contents("http://www.prisconet.com/apps/county/getsummary.php?status=Resolved&wardid=$theward");
              echo $thesummary;
              ?>
             <br/>
             <b>Fowarded Events: </b>
             <?php
               //the url to call
              $thesummary=file_get_contents("http://www.prisconet.com/apps/county/getsummary.php?status=Fowarded&wardid=$theward");
              echo $thesummary;
              ?>
             <br/>
             ...
             <?php
               //the url to call
              $thesummary=file_get_contents("http://www.prisconet.com/apps/county/getsummary.php?status=Dismissed&wardid=$theward");
              echo $thesummary;
              ?>
             <br/>
         </div> 
