...
if (!isset($_SESSION['suserid']))
{
    header("Location:index.php");
                                ...
                                //get the details of this reported event
        ...
        <nav class="navbar navbar-inverse navbar-fixed">
            <div class="container-fluid">
                <div class="navbar-header">
                    ...
                    <a class="navbar-brand" href="#">Reported Event Details
                    <?php
                                       //the url to call the json data
                    ...
                    <div class="col-md-12">
                        <div class="card">
                            ...
                            <div class="row"> 
                                ...
                                <div class="col-sm-3">
                                    <a href="#rj" data-toggle="collapse">Feedback</a>

                                        <div id="rj" class="collapse">
                                        Kindly give feedback to the person who has reported
