...
if (isset($_SESSION['success'])) {
    ?>
                        ...
                        <meta content="2;admin.php" http-equiv="refresh" />
    <?php
    //unset the session
...
foreach ($data as $sc) {
    ...
    ?><option value="<?php echo $wardid; ?>"><?php echo $name; ?></option><?php
                            ...
                            <div class="col-md-6">
                                <div class="card">
                                    <div class="header">
                                        <h4 class="title">Monitoring & Evaluation Officers</h4>
                                        <p class="category">Input a new Monitoring and Evaluation Officer</p>
                                    </div>
                                    <div class="content">
                                        <form action="newmonitoring.php" method="post">
                                            <div class="form-group">
                                                <label for="name">Full Name:</label>
                                                <input type="text" class="form-control" id="name" name="name" required>
                                            </div>
                                            ...
                                            <div class="form-group">
                                                <label for="service">Sub-County:</label>
                                    ...
                                    <div class="content">
                                        <form action="newsector.php" method="post">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control" id="description" name="descroption" required>
                                            </div>
                                            <button type="submit" class="btn btn-default">Add</button>
                                        </form>   
